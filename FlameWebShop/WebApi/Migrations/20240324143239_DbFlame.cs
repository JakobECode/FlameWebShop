    ...
    public partial class DbFlame : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProfileCreditCardEntity", x => new { x.UserProfileId, x.CreditCardId });
                    table.ForeignKey(
                        name: "FK_UserProfileCreditCardEntity_CreditCardEntities_CreditCardId",
                        column: x => x.CreditCardId,
                        principalTable: "CreditCardEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProfileCreditCardEntity_UserProfileEntities_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "UserProfileCreditCardEntity",
                column: "CreditCardId");
        }
